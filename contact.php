...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($message)) {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = '86cf4b7177b666';
            $mail->Password   = 'f012135b2aea79';
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port       = 2525;
            
            // Recipients
            $mail->setFrom('noreply@booknest.com', 'BookNest Website');
            $mail->addAddress('ychen21@rrc.ca', 'BookNest Admin');
            $mail->addReplyTo($email, $name);
            
            // Content
            $mail->isHTML(true);
            $mail->Subject = 'BookNest Contact Form - Message from ' . $name;
            ...
            $email_body .= "
                    ...
                    <div class='footer'>
                        <p>This message was sent from the BookNest website contact form.</p>
            ...
            $plain_text_body = "New Contact Form Submission from BookNest\n\n";
            ...
            $plain_text_body .= "This message was sent from the BookNest website contact form.\n";
            $plain_text_body .= "Sent on: " . date('F j, Y \a\t g:i A');
            ...
            // For debugging purposes, you can uncomment the line below to see the actual error
